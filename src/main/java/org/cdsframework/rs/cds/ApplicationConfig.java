...
public class ApplicationConfig extends BaseResourceConfig {    
    ...
    public ApplicationConfig() {
        ...
        dtoClasses.add(CriteriaDataTemplateRelDTO.class);
        dtoClasses.add(CriteriaDataTemplateRelNodeDTO.class);
        ...
        dtoClasses.add(DataModelClassDTO.class);
        dtoClasses.add(DataModelClassNodeDTO.class);
        dtoClasses.add(DataModelDTO.class);
        dtoClasses.add(DataTemplateDTO.class);
        dtoClasses.add(DataTemplateLinkRelDTO.class);
